import 'package:ebook/ui/pages/dashboard/categories/detail_categories/detail_categories_page.dart';
            ...
            return GestureDetector(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => DetailCategoriesPage(
                            sourceCategories: categoriesName[index])));
              },
              child: Stack(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(categoriesName[index],
                        style: StylingText.headLineText
